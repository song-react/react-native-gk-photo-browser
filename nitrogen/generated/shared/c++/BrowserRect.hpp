...
namespace margelo::nitro::gkphotobrowser {
  ...
  /**
   * A struct which can be represented as a JavaScript object (BrowserRect).
   */
  struct BrowserRect final {
  public:
  ...
  public:
    BrowserRect() = default;
    explicit BrowserRect(double x, double y, double width, double height): x(x), y(y), width(width), height(height) {}

  public:
    friend bool operator==(const BrowserRect& lhs, const BrowserRect& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ BrowserRect <> JS BrowserRect (object)
  template <>
  struct JSIConverter<margelo::nitro::gkphotobrowser::BrowserRect> final {
    static inline margelo::nitro::gkphotobrowser::BrowserRect fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::gkphotobrowser::BrowserRect(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::gkphotobrowser::BrowserRect& arg) {
